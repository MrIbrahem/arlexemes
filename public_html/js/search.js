...
async function fetchWikidataSuggestions(query) {
    ...
    // ---
    let data_source = document.getElementById("data_source").value.trim() || "";
    // ---
    ...
    try {
        ...
        displaySuggestions(data.search); // دالة لعرض الاقتراحات
    } catch (error) {
...
function load_search() {
    ...
    searchInput.addEventListener('input', (event) => {
        ...
        debounceTimeout = setTimeout(() => {
            fetchWikidataSuggestions(query);
