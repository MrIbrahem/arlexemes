                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item {% if result.tab.page == 1 %}disabled{% endif %}">
                                        <a class="page-link"
                                            href="{{ url_for('view_logs', page=1, **common_args) }}"
                                    ...
                                    <li class="page-item {% if p == result.tab.page %}active{% endif %}">
                                        <a class="page-link"
                                            href="{{ url_for('view_logs', page=p, **common_args) }}">
                                            {{ p }}
                                        </a>
                                    </li>
                                    {% endfor %}
                            ...
                            <table class="table table-striped table-hover table-bordered soro">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {%if log.wd_id %}
                                            <a href="https://www.wikidata.org/entity/{{log.wd_id}}#P11038"
                                                target="_blank">
                                                {{log.wd_id}}
                                            </a>
                                            {%endif%}
                                        ...
                                        <td>
                                            {%if log.wd_id_category %}
                                            {{log.wd_id_category}}
                                            <!-- <a href="https://www.wikidata.org/entity/{{log.wd_id_category}}" target="_blank">{{log.wd_id_category}}</a> -->
                                            {%endif%}
                                        </td>
                                    </tr>
                                    {% endfor %}
